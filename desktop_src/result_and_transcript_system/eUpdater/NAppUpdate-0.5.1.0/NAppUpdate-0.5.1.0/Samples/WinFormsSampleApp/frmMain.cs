...
namespace WinFormsSampleApp
{
	public partial class frmMain : Form
	{
		...
		public frmMain()
		{
            ...
            //https://github.com/synhershko/NAppUpdate/releases/download/0.5.1.0/Feedbuilder-0.5.1.0.zip
			UpdateManager updManager = UpdateManager.Instance;
            updManager.UpdateSource = new SimpleWebSource("https://github.com/synhershko/NAppUpdate/releases/download/0.5.1.0/Feedbuilder-0.5.1.0.zip" /* update feed URL */);
