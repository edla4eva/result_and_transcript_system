...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 05, 2021 at 09:26 PM
...
(1, 'Admin', 'Person', 'admin', 'uwascanix@gmail.com', '$2y$10$ZVsBi2f2DAbz/MG3zHcRVO1M7s9dGQl7SySN0WPBzUEpL/AIRgFda', NULL, '$2y$10$htn0Jpt2siyQW2.54e7W6egEJ3QJdJU2nbrB9sI.TpmYCIhqwY7Xe', NULL, '', 1, 2, NULL, '2020-05-29 13:54:15', '2019-10-08 15:35:17', '2020-05-29 13:54:15', NULL, 1),
(2, 'Admin2', 'Person2', 'admin2', 'eddie.olaye@gmail.com', 'md5', NULL, 'md5', NULL, '', 1, 2, NULL, '2020-05-29 13:54:15', '2019-10-08 15:35:17', '2020-05-29 13:54:15', NULL, 1);
...
INSERT INTO `users` (`id`, `first_name`, `last_name`, `username`, `email`, `password`, `activation_code`, `persist_code`, `reset_password_code`, `permissions`, `is_activated`, `role_id`, `activated_at`, `last_login`, `created_at`, `updated_at`, `deleted_at`, `is_superuser`) VALUES
(1, 'Admin', 'Person', 'admin', 'uwascanix@gmail.com', '21232f297a57a5a743894a0e4a801fc3', NULL, '21232f297a57a5a743894a0e4a801fc3', NULL, '', 1, 2, NULL, '2020-05-29 13:54:15', '2019-10-08 15:35:17', '2020-05-29 13:54:15', NULL, 1),
(2, 'Admin2', 'Person2', 'admin2', 'eddie.olaye@gmail.com', '21232f297a57a5a743894a0e4a801fc3', NULL, 'md5', NULL, '', 1, 2, NULL, '2020-05-29 13:54:15', '2019-10-08 15:35:17', '2020-05-29 13:54:15', NULL, 1);
...
ALTER TABLE `backend_users`
  ...
  ADD KEY `act_code_index` (`activation_code`) USING BTREE,
  ADD KEY `reset_code_index` (`reset_password_code`) USING BTREE,
  ADD KEY `admin_role_index` (`role_id`) USING BTREE;
...
ALTER TABLE `users`
  ADD PRIMARY KEY (`id`) USING BTREE,
  ADD UNIQUE KEY `login_unique` (`username`) USING BTREE,
  ADD UNIQUE KEY `email_unique` (`email`) USING BTREE,
  ADD KEY `act_code_index` (`activation_code`) USING BTREE,
  ADD KEY `reset_code_index` (`reset_password_code`) USING BTREE,
  ADD KEY `admin_role_index` (`role_id`) USING BTREE;
