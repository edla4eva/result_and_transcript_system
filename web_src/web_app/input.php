        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item active">
              <a class="nav-link" href="tree.php">Family Tree </a>
            </li>
      ...
      <div class="row">
        ...
        <div class="col-sm-6 input-box" id="input">
          ...
          <form class= "form-signin" method="post" action="svr/input-data.php">  <!-- form action="svr/login.php" or button onClick="pasuser(this.form)"  -->
            ...
            <span class="btn btn-lg btn-primary btn-block" onClick="showConfirmation();">Add Information</span>
            <button class="btn btn-lg btn-primary btn-block"  type="submit" 
            name ="submit" id ="submit" style="display: none;">Confirm Action</button>
          </form>
            <!-- Modal -->
              ...
              <div class="card" id="myModalCard" style="width: 22rem; margin:auto;">
                  ...
                  <!-- <img src="brand/tree.jpg"></img> -->
                      ...
                      <div class="card-text" id="card-data" style="border-width:1; display: block;">
                        ...
                        <?php include 'svr/php-to-ul-flat.php'; ?>
                      </div>
